...
export const TacticalMap = () => {
    ...
    const zoneData = useMemo(() => {
        return ZONE_CONFIG.map(config => {
            // Find location matching this zone
            // Note: Backend might use "Zone A" string or similar. Matching by substring or exact.
            ...
            // Competition is not in Location interface yet, defaulting to random or 0
            const competition = 0;
        ...
        <div className="glass-card h-[400px] flex flex-col overflow-hidden relative group">
            ...
            <div className="flex-1 bg-[#05070a] relative overflow-hidden flex items-center justify-center perspective-[1000px]">
                ...
                >
                    ...
                    {zoneData.map((zone, i) => {
                        if (!zone.active) {
                            // Render placeholder for inactive zone
                            return (
                                <div key={zone.id}
                        ...
                        // Height based on traffic (mock heatmap logic)
                        const height = zone.traffic;
            ...
            <div className="absolute bottom-4 right-4 flex gap-2">
                ...
                <button
                    className="p-2 glass rounded hover:bg-white/10"
                    aria-label="Show traffic trends"
                >
                    <TrendingUp size={14} />
                </button>
            </div>
